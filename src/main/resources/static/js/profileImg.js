    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="profileImgClose">닫기</button>
        </div>
      </div>
    </div>
  </div>
...
if (profileOptionButton !== null) {
	var profileImgModalload = document.querySelector('#profileImgModal');
	var profileImgSendButton = document.querySelector('#profileImgSend'); // 이미지 전송버튼
	...
	profileOptionButton.addEventListener('click', function() {
		...
		if (profileImgname === null || profileImgname === "") {
			document.querySelector('#profileChangeImg').remove();
			document.querySelector('#profileChangeImgDiv').innerHTML = '기존 이미지 파일이<br>없습니다.';
		} else {
			document.querySelector('#profileChangeImg').src = sessionStorage.getItem('profileImage');
		}
		profileImgSendButton.addEventListener('click', () => {
			// 선택한 파일의 정보를 받아오기

  ...
  <div class="modal-dialog modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="margin-top:2%; padding: 1%; text-align: justify; font-size:0.9em; border:2px solid rgba(140, 145, 236, 0.5); line-height:120%;">${itemContent2.replace(/\. /g, ".<br><br>")}</p>
      </div>
    </div>
  </div>
</div>
...
`;
								...
								document.querySelector('#modalDetail').innerHTML += content3;

      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body message_category">
            <a type="button" class="receiveMessage_button">받은 메세지</a>
            <a type="button" class="sendMessage_button">보낸 메세지</a>
          </div>
          <div class="modal-body message_box">
          </div>
          <div class="modal-body message_write">
            <h1 class="modal-title fs-5" id="message_sendtitle">메세지 보내기</h1>
            <div class="mb-3 col-4">
              <label for="receive_userid" class="form-label">보낼 사람</label>
              <input type="text" class="form-control" id="receive_userid">
            </div>
            <div class="mb-3">
              <label for="receive_message" class="form-label">보낼 메세지</label>
...
function sendNewPage(pageCurrent) {
  if (pageCurrent == -1) {
    ...
    for (var i = messageIdx; i < messageTableList.length; i++) {
      ...
      var mess_no = sendMessageData.messageIdx;
